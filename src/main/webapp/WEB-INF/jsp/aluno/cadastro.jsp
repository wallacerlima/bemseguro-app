...
<div class="container mt-3">
  ...
  <form action="/aluno/incluir" method="post">
    <div class="mb-3 mt-3">
    <label>Nome:</label>
      <input type="text" class="form-control" placeholder="Entre com seu nome" name="nome" value="Wallace">
    </div>
    
    <div class="mb-3 mt-3">
      <label>E-mail:</label>
      <input type="email" class="form-control" placeholder="Entre com seu e-mail" name="email" value="wallacereislima@gmail.com"> 
    </div>
    
    <div class="mb-3 mt-3">
    <label>Idade:</label>
      <input type="text" class="form-control" placeholder="Entre com sua idade" name="idade" value="28">
    </div>
    
    <div class="mb-3 mt-3">
    <label>Mensalidade:</label>
      <input type="text" class="form-control" placeholder="Entre com sua mensalidade" name="mensalidade" value="499">
    </div>
